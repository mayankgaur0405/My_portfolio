...
import profileImage from '../../assets/myPic-removebg-preview (1).png'; // replace with your image
    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <a
            href="https://drive.google.com/file/d/1jSEwJendKRaj7dCTP_3PcopKScbmxgOG/view?usp=drive_link"
            target="_blank"
